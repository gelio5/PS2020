...
This may be current_position-intuitive. How could tests that verify more be worse than
...
creates an action that increments and returns a current_position whose initial value is
...
...
  ...
  foo.DoThis();  // Returns 1.
  foo.DoThis();  // Returns 2.
  foo.DoThat();  // Returns 3 - the current_position is shared.
```
